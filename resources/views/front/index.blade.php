...
<section id="Trending" class="w-full max-w-[1280px] mx-auto px-[52px] mt-[100px]">
    <div class="flex flex-col gap-8">
        <div class="flex items-center justify-between">
            <h2 class="font-Neue-Plak-bold text-[32px] leading-[44.54px] capitalize">Highly sought-after 🔥 <br>
                <a href="#" class="flex items-center rounded-full py-4 px-6 h-[56px] gap-3 bg-aktiv-orange">
                    <span class="font-semibold text-white">See All</span>
                    <span class="w-6 h-6 rounded-full bg-white text-center align-middle text-aktiv-orange font-bold">
                </a>
        </div>
                        ...
                        <div class="flex flex-col gap-[18px]">
                            <div class="flex items-center gap-3">
                                <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                                    <img src="{{Storage::url($itemNewWorkshop->instructors->avatar)}}" class="w-full">
                                </div>
                                ...
                                @if($itemNewWorkshop->is_open)
                                    ...
                                    @else
                                        <div class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1
                                            ...
                                            <img src="{{asset('assets/image/icons/medal-star.svg')}}" class="w-6 h-6" alt="icon">
        ...
        <section id="Testimony">
            <div class="flex flex-col gap-8">
                ...
                <div class="swiper w-full">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div
                                    ...
                                    <p
                                        class="font-['Times_New_Roman'] font-bold text-[38px] leading-[60.8px] text-white">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p
                                        ...
                                        sunt incidunt obcaecati assumenda error ❤️ ."
                                    </p>
                                    <div class="flex justify-between items-center">
                                        <div class="flex flex-col gap-1">
                                            <p class="font-semibold text-lg leading-[27px] text-white">Otter</p>
                    ...
                    <div
                        class="absolute w-full max-w-[1244px] mx-auto left-1/2 top-1/2 transform -translate-x-1/2 z-10">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="font-semibold text-lg leading-[27px]">In-Depth Learning from Experts Instructor
                            </h3>
                        </div>
        ...
        <div
            ...
            <div class="flex flex-col justify-center p-[90px] pr-[60px] gap-8">
                <p class="rounded-full w-fit py-3 px-8 font-semibold text-aktiv-blue bg-[#DFEFFF]">What are you waiting
                    for? Join now 🔥 </p>
                <p class="font-bold text-[32px] leading-[48px] text-white">Study more purposefully and fill your day
                    with productivity</p>
